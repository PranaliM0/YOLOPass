...
Rails.application.routes.draw do
  ...
  namespace :admin do
    ...
    resources :organizers, only: %i[index destroy]
  ...
  namespace :organizer do
    ...
    resources :discount_codes, only: %i[index show create update destroy]
    get 'available_venues', to: 'venues#available'
    get 'event_details/:id', to: 'events#event_details', as: 'event_details'
    resources :events do
      resources :discount_codes, only: %i[index show edit update destroy]
    end
  ...
  namespace :attendee do
    ...
    resources :registration_carts, only: %i[index create destroy] do
      member do
